...
runBayesSpace <- function(fn, q, platform, d, nhvgs, lognorm){
  ...
  sce<- spatialPreprocess(sce, platform=platform, n.PCs=d, n.HVGs=nhvgs, log.normalize=TRUE)
